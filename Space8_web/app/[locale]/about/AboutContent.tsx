...
import { Focus, Target, Smartphone, DoorClosed, Check, MapPin, MessageCircle, Mail, ChevronDown, Clock } from "lucide-react";
...
// 零打擾全專注 / 專業設備 / 科技體驗 / 獨立空間 — one icon per mission_items entry.
const MISSION_ICONS = [Focus, Target, Smartphone, DoorClosed];
            ...
            {missionItems.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 style={{ fontSize: "22px", fontWeight: 700, margin: "20px 0 8px", color: DARK }} data-cms-key={`about.mission.${i}.title`}>
                    {item.title}
                  </h3>
