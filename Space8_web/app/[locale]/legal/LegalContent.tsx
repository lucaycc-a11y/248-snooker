        ...
        >
          ...
          <p
            style={{
              ...
              margin: 0,
              paddingLeft: "36px",
              // Legal-section bodies may contain sub-point line breaks (\n),
              // e.g. the terms-of-service bulleted clauses — preserve them.
              whiteSpace: "pre-line",
            }}
          >
            {s.body}
              ...
              {tab === "terms" && (
                <>
                  <p
                    ...
                    data-cms-key="legal.terms_preamble"
                  >
                    <CMSText k="legal.terms_preamble">{t("terms_preamble")}</CMSText>
                  </p>
