  ...
  if (phase === "otp") {
    return (
      <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.35, ease: EASE }}>
        ...
        <p data-cms-key="auth.otp.subtitle" style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", marginBottom: 24 }}>
  ...
  if (phase === "phone") {
    return (
      <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.35, ease: EASE }}>
        ...
        <p data-cms-key="auth.sms.subtitle" style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", marginBottom: 24 }}>
          {t("sms_subtitle")}
        </p>
      ...
      <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.35, ease: EASE }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <button
            ...
            style={{ background: "none", border: "none", color: "rgba(255,255,255,0.62)", fontSize: 13, cursor: "pointer", textAlign: "center" }}
          >
            {t("switch_to_otp")}
          </button>
        </div>
    ...
    <div>
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "4px 0" }}>
          ...
          <span style={{ fontSize: 11, letterSpacing: "0.12em", color: "rgba(255,255,255,0.5)", textTransform: "uppercase" }}>{t("or")}</span>
          <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.12)" }} />
        </div>
        ...
        <button
          ...
          style={{ marginTop: -4, background: "none", border: "none", color: "rgba(255,255,255,0.62)", fontSize: 13, cursor: "pointer", textAlign: "center" }}
        >
      ...
      <p data-cms-key="auth.terms" style={{ marginTop: 20, textAlign: "center", fontSize: 13, lineHeight: 1.6, color: "rgba(255,255,255,0.65)" }}>
        {t("terms")}
      </p>
    </div>
  )
