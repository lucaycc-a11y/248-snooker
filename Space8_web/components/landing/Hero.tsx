...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* TODO: 需要 Luca 提供正確素材 — poster + video currently show a
          Western-style pool table with a corner pocket and a single 8-ball;
          Space8 uses 星牌中式桌球枱 (Chinese eight-ball tables), so this
          asset doesn't match the actual venue. Swap /video/hero-poster.jpg
          and /video/248Snooker_hero.mp4 once real footage is available. */}
      ...
      <div className="absolute left-1/2 top-[28%] z-10 flex w-full -translate-x-1/2 flex-col items-center px-6 text-center md:top-[22%]">
        ...
        {/* Subcopy — one line under the headline, muted */}
        <p
          className="mt-3 text-[clamp(14px,3.2vw,16px)] md:mt-4 md:text-[18px]"
          style={{
          ...
          data-cms-key="hero.subcopy"
        >
          <CMSText k="hero.subcopy">{t("subcopy")}</CMSText>
        </p>
