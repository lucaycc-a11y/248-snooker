...
// FIXED: Uses real schema (tier) not phantom (tier_id)
        ...
        >
          <div className="h-full w-full rounded-3xl bg-[#0F131C]/90 p-6 backdrop-blur-xl">
            ...
            <div className="flex items-start justify-between">
              ...
              <div
                className="font-label rounded-full px-3 py-1 text-xs text-white shadow-lg"
...
// ────────────────────────────────────────────────────────────────────────────
// § TIER RING COLOR HELPER (for card border gradient)
// ────────────────────────────────────────────────────────────────────────────

function getTierRingColorPair(tier: string): [string, string] {
  switch (tier) {
    case 'amateur':
      return ['rgba(102, 126, 234, 0.6)', 'rgba(118, 75, 162, 0.4)'] // Nova blue-purple
    case 'century':
      return ['rgba(189, 195, 199, 0.6)', 'rgba(44, 62, 80, 0.4)'] // Platinum silver
    case 'maximum':
      return ['rgba(240, 147, 251, 0.6)', 'rgba(245, 87, 108, 0.4)'] // Diamond pink
    default:
