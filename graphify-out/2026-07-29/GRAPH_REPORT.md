...
## Corpus Check
- 446 files · ~787,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1809 nodes · 3271 edges · 232 communities (176 shown, 56 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c7fdcf5`
...
## Communities (232 total, 56 thin omitted)

### Community 0 - "createClient"
Cohesion: 0.26
Nodes (12): POST(), POST(), POST(), POST(), POST(), GET(), POST(), GET() (+4 more)

### Community 1 - "getAdminBookings.ts"
Cohesion: 0.29
Nodes (8): GET(), isRecord(), PATCH(), AdminBookingRow, AdminBookingsQuery, AdminBookingsResult, getAdminBookings(), normalize()

### Community 2 - "booking/server.ts"
Cohesion: 0.12
Nodes (23): EASE, SPRING, EASE, fmt(), PeriodPricingSections(), DaySlotRow, getDaySlots(), getRangeSlots() (+15 more)
...
Cohesion: 0.06
Nodes (31): bookingEnd(), BookingsTab(), bookingStart(), calendarLink(), canRefund(), canReschedule(), canShowQr(), EASE (+23 more)

### Community 6 - "send.ts"
Cohesion: 0.07
Nodes (46): GET(), assertRpcSucceeded(), BookingPaymentContext, ConfirmBookingResult, handleFailed(), handleGroupSucceeded(), handleRefunded(), handleSucceeded() (+38 more)
...
Cohesion: 0.15
Nodes (17): DELETE(), GET(), isRecord(), LOCALES, PATCH(), CardRow, DELETE(), isRecord() (+9 more)

### Community 11 - "tokens.ts"
Cohesion: 0.10
Nodes (16): AdminBlogListPage(), getPosts(), AccessLog, DeviceStatus, LockoutStatus, RelayStatus, AdminDoorPage(), Tokens (+8 more)

### Community 12 - "tools.ts"
Cohesion: 0.05
Nodes (54): AdminDashboardPage(), money(), ChatMessage, isRecord(), POST(), GET(), isRecord(), Locale (+46 more)

### Community 13 - "AuthCard.tsx"
Cohesion: 0.15
Nodes (15): DoorCardTable(), AppleSignInButton(), EASE, OtpChannel, Phase, Prefill, GoogleSignInButton(), OtpInput() (+7 more)
...
### Community 19 - "config/route.ts"
Cohesion: 0.21
Nodes (20): BookingRulesValue, CONFIG_KEYS, ConfigKey, isFiniteNumber(), isRecord(), isTimeString(), PERIOD_DAYS, PERIOD_IDS (+12 more)

### Community 20 - "lib/pricing.ts"
Cohesion: 0.20
Nodes (15): Block, isValidBlock(), POST(), POST(), loadPeriods(), resolveTierForUser(), applyTierPolicy(), BlockPriceDetail (+7 more)
...
Cohesion: 0.15
Nodes (16): AdminBlogEditPage(), getPost(), getSiblings(), AdminTeamPage(), AdminUserRow, ALLOWED_TYPES, POST(), POST() (+8 more)
...
Cohesion: 0.16
Nodes (14): Layout(), AdminSidebar(), NAV_ITEMS, NavItem, linkStyle, primaryLinkStyle, QuickActions(), statusColor() (+6 more)

### Community 29 - "create-intent/route.ts"
Cohesion: 0.29
Nodes (10): POST(), POST(), POST(), getAvailableTables(), periodForStart(), slotBounds(), validateSlotLock(), ErrorSeverity (+2 more)

### Community 30 - "ui/index.ts"
Cohesion: 0.12
Nodes (14): Props, SheetMode, TIERS, BackButton(), baseStyle, fixedStyle, Input, InputProps (+6 more)

### Community 31 - "safeJsonLd"
Cohesion: 0.16
Nodes (13): AboutPage(), META, Home(), PricingPage(), META, VenuePage(), WhatsAppButton(), buildPricingOffersJsonLd() (+5 more)
...
Cohesion: 0.13
Nodes (12): BlogPost, LOCALES, SiblingPost, MemberBookingCalendar(), MemberBookingDay, monthLabel(), statusColor(), Button (+4 more)

### Community 35 - "Nav.tsx"
Cohesion: 0.21
Nodes (9): AccountMenu(), menuItemStyle, TIER_ACCENT, AuthModal(), EASE, Nav(), navItems, NavTheme (+1 more)
...
### Community 56 - "Logo"
Cohesion: 0.19
Nodes (5): Starfield(), Logo(), LogoProps, NOTE: there is no black-on-transparent "mark only" export in the current, HEADLINE_GRADIENT
...
### Community 60 - "getAdmin.ts"
Cohesion: 0.24
Nodes (8): isRecord(), POST(), isRecord(), PATCH(), TargetRow, AdminRole, Row, sendAdminInviteEmail()
...
### Community 62 - "num"
Cohesion: 0.13
Nodes (22): AdminBookingDetailPage(), getBookingDetail(), AdminMemberDetailPage(), getMemberDetail(), AdminMembersPage(), isRecord(), PATCH(), isRecord() (+14 more)

### Community 63 - "i18n-locale-audit.mjs"
Cohesion: 0.29
Nodes (5): allKeys, __dirname, keysByLocale, LOCALES, missing

### Community 64 - "Footer.tsx"
Cohesion: 0.38
Nodes (3): FooterMap, PageShell(), PageShellProps
...
### Community 67 - "gate/verify/route.ts"
Cohesion: 0.60
...
### Community 71 - "ai-settings/route.ts"
Cohesion: 0.40
Nodes (5): GET(), isRecord(), LOCALES, POST(), TONES
...
### Community 78 - "accept-invite/page.tsx"
Cohesion: 0.50
...
### Community 100 - "getConfig"
Cohesion: 0.60
Nodes (4): AdminSettingsPage(), generateMetadata(), getConfig(), getConfigValue()

### Community 127 - "getAdminDoorCards.ts"
Cohesion: 0.60
Nodes (3): GET(), AdminDoorCardsResult, getAdminDoorCards()
...
Cohesion: 0.33
Nodes (5): AdminBookingsPage(), ApiResponse, BookingTable(), STATUS_OPTIONS, statusColor()

### Community 215 - "site-gate/route.ts"
Cohesion: 0.50
Nodes (4): Body, GET(), isBody(), POST()
...
Cohesion: 0.15
Nodes (8): Directions(), HOMEPAGE_FAQ_IDS, GalleryScroll(), mediaItems, slideImages, fmt(), HomePricing(), ContactButton()

## Knowledge Gaps
- **602 isolated node(s):** `Snooker404TableProps`, `TableSize`, `BallSpec`, `EASE`, `SPRING` (+597 more)
...
- **Why does `getServiceSupabase()` connect `getServiceSupabase` to `createClient`, `getAdminBookings.ts`, `booking/server.ts`, `send.ts`, `getAdminData`, `tokens.ts`, `tools.ts`, `middleware.ts`, `SiteGateLog.tsx`, `config/route.ts`, `lib/pricing.ts`, `create-intent/route.ts`, `getAdminCalendar.ts`, `AiSettingsForm.tsx`, `profile.ts`, `getAdmin.ts`, `num`, `gate/verify/route.ts`, `ai-settings/route.ts`, `blog/route.ts`, `accept-invite/page.tsx`, `site-gate/route.ts`, `generate-image/route.ts`, `getAdminDoorCards.ts`?**
...
- **Why does `generateQR()` connect `send.ts` to `qrcode`?**
...
- **Should `booking/server.ts` be split into smaller, more focused modules?**
