...
## Corpus Check
- 446 files · ~791,573 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1810 nodes · 3271 edges · 235 communities (177 shown, 58 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10221ae0`
...
## Communities (235 total, 58 thin omitted)

### Community 0 - "createClient"
Cohesion: 0.09
Nodes (50): acceptInvite(), AcceptInvitePage(), InviteLookup, POST(), POST(), POST(), POST(), POST() (+42 more)

### Community 1 - "bookings/route.ts"
Cohesion: 0.60
Nodes (4): GET(), isRecord(), PATCH(), getAdminBookings()

### Community 2 - "lib/pricing.ts"
Cohesion: 0.20
Nodes (17): DEFAULT_CONFIG, DEFAULT_PERIODS, DEFAULT_SERVICES, DEFAULT_TIERS, PricingPeriod, resolveTier(), ServiceFees, SiteConfig (+9 more)
...
Cohesion: 0.09
Nodes (30): ALL_TABLES, BookPage(), Calendar(), CellState, cellStateFor(), CONFIG, ConfirmationTicket, ConfirmedBooking (+22 more)
...
### Community 6 - "send.ts"
Cohesion: 0.08
Nodes (33): GET(), QrPayload, DEFAULT_OPTIONS, generateAdminQR(), generateBookingQR(), generateMemberQR(), generateQR(), getRecommendedQRSize() (+25 more)
...
Cohesion: 0.18
Nodes (12): ALLOWED_TYPES, POST(), CardRow, DELETE(), isRecord(), PATCH(), GET(), POST() (+4 more)

### Community 11 - "tokens.ts"
Cohesion: 0.12
Nodes (13): AdminBlogListPage(), getPosts(), AdminBookingsPage(), AccessLog, DeviceStatus, LockoutStatus, RelayStatus, AdminDoorPage() (+5 more)
...
Cohesion: 0.06
Nodes (37): BallSpec, createBall(), createBallSpecs(), drawEightBallGlow(), drawEightBallLabel(), drawFeltTexture(), drawPocketRims(), homePositionFor() (+29 more)
...
Cohesion: 0.17
Nodes (14): AboutPage(), Home(), generateMetadata(), PricingPage(), META, VenuePage(), ContactButton(), WhatsAppButton() (+6 more)
...
Cohesion: 0.12
Nodes (12): META, AuthModal(), Logo(), HEADLINE_GRADIENT, FooterMap, EASE, Nav(), navItems (+4 more)
...
### Community 51 - "PlayIntro.tsx"
Cohesion: 0.18
Nodes (5): EASE, VIEWPORT, CardItem, ICONS, PlayIntro()
...
Cohesion: 0.18
Nodes (10): isRecord(), PATCH(), GET(), VALID_METHODS, DELETE(), isRecord(), PATCH(), TargetRow (+2 more)

### Community 61 - "getMember.ts"
Cohesion: 0.05
Nodes (61): AdminBookingDetailPage(), getBookingDetail(), AdminCalendarPage(), AdminMemberDetailPage(), getMemberDetail(), AdminSettingsPage(), GET(), isRecord() (+53 more)

### Community 62 - "getAdminMembers"
Cohesion: 0.67
...
### Community 127 - "whitelist/route.ts"
Cohesion: 0.67
Nodes (3): GET(), isValidIp(), POST()
...
### Community 215 - "useAvailabilityCache.ts"
Cohesion: 0.67
Nodes (3): DaySlot, fmt(), useAvailabilityCache()

### Community 216 - "generate-image/route.ts"
Cohesion: 0.83
Nodes (3): isRecord(), POST(), generateImage()

### Community 217 - "getAvailability.ts"
Cohesion: 0.50
...
Cohesion: 0.15
Nodes (7): Directions(), HOMEPAGE_FAQ_IDS, EASE, mediaItems, slideImages, fmt(), HomePricing()

## Knowledge Gaps
- **603 isolated node(s):** `Snooker404TableProps`, `TableSize`, `BallSpec`, `EASE`, `SPRING` (+598 more)
...
- **Why does `getServiceSupabase()` connect `getServiceSupabase` to `createClient`, `bookings/route.ts`, `getAdminData`, `tokens.ts`, `tools.ts`, `middleware.ts`, `SiteGateLog.tsx`, `config/route.ts`, `AiSettingsForm.tsx`, `profile.ts`, `translate/route.ts`, `service.ts`, `getMember.ts`, `getAdminMembers`, `site-gate/route.ts`, `ai-settings/route.ts`, `blog/route.ts`, `generate-image/route.ts`, `register-request/route.ts`, `confirm/route.ts`, `invite/route.ts`, `whitelist/route.ts`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `framer-motion`, `leaflet`, `send.ts`, `devDependencies`, `next`, `next-intl`, `react`, `react-dom`, `@react-email/render`, `react-leaflet`, `@react-three/fiber`, `recharts`, `remotion`, `@remotion/cli`, `@remotion/player`, `stripe`, `@stripe/react-stripe-js`, `@stripe/stripe-js`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `@tiptap/react`, `@types/canvas-confetti`, `@ybouane/liquidglass`, `lucide-react`, `canvas-confetti`, `matter-js`, `@tiptap/starter-kit`?**
