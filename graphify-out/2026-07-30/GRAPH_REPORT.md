...
Cohesion: 0.17
Nodes (15): AboutPage(), Home(), generateMetadata(), PricingPage(), META, VenuePage(), ContactButton(), WhatsAppButton() (+7 more)
...
Cohesion: 0.22
Nodes (9): @anthropic-ai/sdk, matter-js, dependencies, @anthropic-ai/sdk, matter-js, react, @tiptap/starter-kit, react (+1 more)
...
### Community 64 - "ComingSoonContent.tsx"
Cohesion: 0.15
...
### Community 78 - "getAdminMembers.ts"
Cohesion: 0.20
...
### Community 140 - "door-lock/page.tsx"
Cohesion: 0.33
Nodes (4): AccessLog, DeviceStatus, LockoutStatus, RelayStatus

### Community 156 - "cards/[id]/route.ts"
Cohesion: 0.50
...
### Community 217 - "team/[id]/route.ts"
Cohesion: 0.67
...
Cohesion: 0.16
Nodes (8): Directions(), HOMEPAGE_FAQ_IDS, EASE, GalleryScroll(), mediaItems, slideImages, fmt(), HomePricing()
...
- **Why does `getServiceSupabase()` connect `getServiceSupabase` to `createClient`, `bookings/route.ts`, `humanReadableCode`, `getAdminData`, `tokens.ts`, `tools.ts`, `middleware.ts`, `SiteGateLog.tsx`, `config/route.ts`, `getAdminCalendar.ts`, `cards/[id]/route.ts`, `AiSettingsForm.tsx`, `profile.ts`, `translate/route.ts`, `service.ts`, `getMember.ts`, `getAdminMembers`, `site-gate/route.ts`, `blog/route.ts`, `getAdminMembers.ts`, `members/[id]/page.tsx`, `generate-image/route.ts`, `team/[id]/route.ts`, `register-request/route.ts`, `confirm/route.ts`, `access-log/route.ts`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `framer-motion`, `leaflet`, `devDependencies`, `next`, `next-intl`, `react-dom`, `@react-email/render`, `react-leaflet`, `@react-three/fiber`, `recharts`, `remotion`, `@remotion/cli`, `@remotion/player`, `stripe`, `@stripe/react-stripe-js`, `@stripe/stripe-js`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `@tiptap/react`, `@types/canvas-confetti`, `@ybouane/liquidglass`, `lucide-react`, `canvas-confetti`, `qrcode`, `resend`, `@tiptap/extension-image`, `@tiptap/extension-link`?**
