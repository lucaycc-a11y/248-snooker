# Graph Report - Space8_web  (2026-08-18)

## Corpus Check
- 826 files · ~1,650,210 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9280 nodes · 20643 edges · 518 communities (468 shown, 50 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 343 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6142b49b`
...
1. `getServiceSupabase()` - 158 edges
2. `getAdminData()` - 78 edges
3. `Tokens` - 53 edges
4. `el()` - 51 edges
5. `el()` - 51 edges
6. `createClient()` - 47 edges
...
## Communities (518 total, 50 thin omitted)

### Community 0 - "applyEditing"
Cohesion: 0.09
...
### Community 2 - ".agents/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (51): ALL_TABLES, BookPage(), Calendar(), CellState, cellStateFor(), CONFIG, ConfirmationTicket, ConfirmedBooking (+43 more)

### Community 5 - "MemberDashboard.tsx"
Cohesion: 0.06
Nodes (26): bookingEnd(), BookingSection(), bookingStart(), calendarLink(), canRefund(), canReschedule(), canShowQr(), EASE (+18 more)

### Community 6 - "send.ts"
Cohesion: 0.08
Nodes (35): isRecord(), POST(), GET(), base64url(), checkChar(), QrPayload, signQrToken(), DEFAULT_OPTIONS (+27 more)

### Community 7 - "devDependencies"
Cohesion: 0.06
Nodes (35): autoprefixer, @axe-core/cli, @axe-core/playwright, devDependencies, autoprefixer, @axe-core/cli, @axe-core/playwright, patch-package (+27 more)

### Community 8 - "[slug]/page.tsx"
Cohesion: 0.11
Nodes (22): BlogPage(), BlogPostPage(), formatDate(), generateMetadata(), localePath(), alternatesFor(), localePath(), LOCALES (+14 more)
...
Cohesion: 0.05
Nodes (47): AdminAiSettingsPage(), getInitialSettings(), AdminBlogListPage(), getPosts(), AdminBookingsPage(), AdminMemberDetailPage(), getMemberDetail(), money() (+39 more)
...
Cohesion: 0.07
Nodes (35): POST(), NOTE: this write can only 500 — auth is fully settled above, so a 401 can, errorKey(), LoginForm(), safeReturnUrl(), DoorCardTable(), AccountMenu(), menuItemStyle (+27 more)
...
### Community 17 - ".agents/skills/impeccable/scripts/live-status.mjs"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (34): AdminSettingsPage(), generateMetadata(), EASE, SPRING, EASE, fmt(), PeriodPricingSections(), DaySlotRow (+26 more)
...
### Community 25 - "service.ts"
Cohesion: 0.09
Nodes (34): acceptInvite(), AcceptInvitePage(), InviteLookup, Layout(), ALLOWED_REDIRECT_SCHEMES, failureMap, getClientIp(), POST() (+26 more)
...
Cohesion: 0.09
Nodes (21): AboutPage(), META, Home(), PricingPage(), META, VenuePage(), Directions(), EASE (+13 more)
...
### Community 35 - ".claude/skills/impeccable/scripts/live-status.mjs"
Cohesion: 0.18
...
Cohesion: 0.08
Nodes (16): EASE, VIEWPORT, EASE, highlight(), ICON_PROPS, Member(), ModalData, SPRING (+8 more)
...
### Community 60 - "getServiceSupabase"
Cohesion: 0.05
Nodes (71): AdminBlogEditPage(), getPost(), getSiblings(), AdminTeamPage(), AdminUserRow, GET(), isRecord(), LOCALES (+63 more)

### Community 61 - "getMember.ts"
Cohesion: 0.08
Nodes (39): AdminBookingDetailPage(), getBookingDetail(), AdminCalendarPage(), AdminDoorPage(), AdminMembersPage(), isRecord(), PATCH(), GET() (+31 more)

### Community 62 - "CreditsContent.tsx"
Cohesion: 0.25
...
### Community 64 - "template-send.ts"
Cohesion: 0.11
Nodes (22): POST(), DAY_NAMES, padTime(), PAYMENT_ICON_MAP, TicketCard(), TicketCardProps, getTableName(), TABLE_NAMES (+14 more)
...
### Community 67 - ".claude/skills/impeccable/scripts/lib/staleness.mjs"
Cohesion: 0.15
Nodes (25): PRODUCT_DEPRECATED_SECTIONS, PRODUCT_V4_SECTIONS, productStampLine(), readProductSchemaVersion(), readSidecarSchemaVersion(), stampProductSchema(), BUILD_PATH_VALUES, checkBuildPathUnset() (+17 more)
...
### Community 72 - ".agents/skills/impeccable/scripts/doctor.mjs"
Cohesion: 0.08
Nodes (57): applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns(), rel(), renderText(), safeRead() (+49 more)

### Community 73 - ".claude/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.20
Nodes (23): bakeParamValues(), collectAllSelectors(), collectSelectorsFromNodes(), escapeRegExp(), formatBody(), isToggleOn(), normalizeSelector(), normalizeToggleForVar() (+15 more)
...
Cohesion: 0.06
Nodes (31): @anthropic-ai/sdk, bcryptjs, matter-js, dependencies, @anthropic-ai/sdk, bcryptjs, matter-js, react-dom (+23 more)

### Community 132 - "routing.ts"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (61): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, appendDesignSystemNote(), appendDesignSystemNoteOnce(), applyConfigSource(), applyDetectorConfigSource(), canonicalPathCache (+53 more)
...
### Community 143 - "captureElementToBlob"
Cohesion: 0.13
...
### Community 144 - "resolveLiveInjectionAnchor"
Cohesion: 0.16
...
### Community 148 - "member/bookings/[id]/page.tsx"
Cohesion: 0.25
Nodes (12): ComingSoonPage(), metadata, LoginPage(), metadata, safeReturnUrl(), MemberBookingPage(), metadata, MemberPage() (+4 more)

### Community 150 - "navigation.ts"
Cohesion: 0.11
Nodes (11): EASE, FACILITY_ICON_CLASSES, FACILITY_ICONS, SERVICE_ICON_CLASSES, SERVICE_ICONS, TitledItem, VIEWPORT, HEADLINE_GRADIENT (+3 more)
...
Cohesion: 0.08
Nodes (24): getKpayBaseUrl(), KPayApiResponse, KPayProvider, requireEnv(), buildSignText(), generateNonce(), generateTestKeyPair(), signKpay() (+16 more)
...
### Community 262 - ".claude/skills/impeccable/scripts/context-signals.mjs"
Cohesion: 0.21
...
### Community 266 - ".agents/skills/impeccable/scripts/lib/impeccable-paths.mjs"
Cohesion: 0.10
...
### Community 267 - "checkElementDesignSystemDOM"
Cohesion: 0.15
...
### Community 274 - ".agents/skills/impeccable/scripts/live/frameworks/tag-strategy.mjs"
Cohesion: 0.26
...
### Community 276 - ".claude/skills/impeccable/scripts/live/session-store.mjs"
Cohesion: 0.19
...
### Community 279 - ".agents/skills/impeccable/scripts/live/insert-ui.mjs"
Cohesion: 0.11
...
### Community 288 - "checkHtmlPatterns"
Cohesion: 0.13
Nodes (27): buildHtmlPatternCorpora(), checkHtmlPatterns(), collectCssCustomProps(), collectMarqueeKeyframes(), collectPulseKeyframes(), cssLengthToPx(), cssTextHasDarkRootBg(), enclosingCssSelector() (+19 more)
...
Cohesion: 0.11
Nodes (23): AlipayBadgeIcon(), AlipayHKBadgeIcon(), AmexBadgeIcon(), ApplePayBadgeIcon(), BadgeProps, DinersBadgeIcon(), FpsBadgeIcon(), GooglePayBadgeIcon() (+15 more)
...
Cohesion: 0.27
Nodes (12): assertRpcSucceeded(), BookingSummary, ConfirmBookingResult, handleFailed(), handleRefunded(), handleSucceeded(), markWebhookFailed(), markWebhookProcessed() (+4 more)
...
### Community 311 - "ComingSoonContent.tsx"
Cohesion: 0.15
...
### Community 313 - "LegalDocumentRenderer.tsx"
Cohesion: 0.19
...
### Community 328 - "SettingsForm.tsx"
Cohesion: 0.17
...
### Community 330 - ".agents/skills/impeccable/scripts/context-signals.mjs"
Cohesion: 0.19
...
### Community 339 - "Nav.tsx"
Cohesion: 0.22
Nodes (9): AuthModal(), Logo(), EASE, Nav(), navItems, NavTheme, pillStyle(), PageShell() (+1 more)

### Community 340 - ".claude/skills/impeccable/scripts/lib/surface-briefs.mjs"
Cohesion: 0.44
...
Cohesion: 0.14
Nodes (14): scripts, backfill:human-codes, build, check:i18n, cms:audit, cms:seed, cms:sync, dev (+6 more)
...
### Community 350 - ".claude/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.21
...
### Community 354 - "isRepeatedTextContainer"
Cohesion: 0.25
...
### Community 367 - ".agents/skills/impeccable/scripts/live/source-search.mjs"
Cohesion: 0.50
...
### Community 404 - "ReschedulePicker.tsx"
Cohesion: 0.21
...
### Community 409 - "_components-demo/page.tsx"
Cohesion: 0.30
...
### Community 413 - "renderGroupedTemplate"
Cohesion: 0.26
...
### Community 426 - "resolveLiveInjectionAnchor"
Cohesion: 0.16
Nodes (19): buildSvelteExpressionTextMap(), buildSveltePropValuesFromLiveElement(), buildSveltePropValuesV2(), cloneWithoutElements(), collectTextNodes(), collectVisibleTexts(), cssEscapeIdent(), elementMatchesOriginalMarkup() (+11 more)
...
Cohesion: 0.12
Nodes (42): Block, isValidBlock(), POST(), Block, isValidBlock(), POST(), POST(), POST() (+34 more)

### Community 433 - "Shape"
Cohesion: 0.25
Nodes (8): Cadence, Confirm and stop, Phase 1: Discovery interview, Phase 2: Resolve the design direction, Phase 3: Write the brief, Round 1: purpose, people, and outcome, Round 2: material, behavior, and boundaries, Shape

### Community 434 - ".claude/skills/impeccable/scripts/critique-storage.mjs"
Cohesion: 0.25
...
### Community 435 - ".agents/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.21
Nodes (9): assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts(), resolveLiveBrowserScriptParts(), loadBrowserScripts(), LIVE_CHROME_MOUNT_CONTRACT, LIVE_UI_COMPONENT_IDS (+1 more)
...
### Community 450 - "AdminAIPanel.tsx"
Cohesion: 0.60
...
### Community 476 - ".claude/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.50
...
### Community 487 - ".agents/skills/impeccable/scripts/hook.mjs"
Cohesion: 0.83
...
### Community 496 - ".agents/skills/impeccable/reference/bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 497 - "checkRadialSpotlight"
Cohesion: 0.32
...
### Community 502 - ".claude/skills/impeccable/reference/bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 503 - "door-lock/page.tsx"
Cohesion: 0.33
Nodes (4): AccessLog, DeviceStatus, LockoutStatus, RelayStatus

### Community 504 - "Adaptation Strategies"
Cohesion: 0.40
...
## Knowledge Gaps
- **2330 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2325 more)
...
- **Why does `el()` connect `el` to `.agents/skills/impeccable/scripts/live-browser.js`, `connectSSE`, `.agents/skills/impeccable/scripts/detector/detect-antipatterns-browser.js`, `parseRgb`, `.agents/skills/impeccable/scripts/detector/engines/static-html/css-cascade.mjs`, `initGlobalBar`, `.agents/skills/impeccable/scripts/detector/design-system.mjs`, `.agents/skills/impeccable/scripts/live/svelte-ast.mjs`, `.agents/skills/impeccable/scripts/detector/browser/injected/index.mjs`, `.agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs`, `.agents/skills/impeccable/scripts/detector/rules/checks.mjs`, `postSerializedFindings`, `collectBrowserFindings`, `setLiveState`, `initPageChat`, `.agents/skills/impeccable/scripts/detector/engines/regex/detect-text.mjs`?**
