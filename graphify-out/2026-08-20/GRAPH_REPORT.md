...
## Corpus Check
- 838 files · ~1,707,372 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9343 nodes · 20753 edges · 515 communities (462 shown, 53 thin omitted)
...
## Communities (515 total, 53 thin omitted)
...
### Community 2 - "api/ai/chat/route.ts"
Cohesion: 0.09
Nodes (38): AdminDashboardPage(), ChatMessage, isRecord(), POST(), GET(), isRecord(), POST(), isRecord() (+30 more)
...
### Community 6 - "send.ts"
Cohesion: 0.05
Nodes (54): isRecord(), POST(), GET(), DAY_NAMES, padTime(), PAYMENT_ICON_MAP, TicketCard(), TicketCardProps (+46 more)
...
Cohesion: 0.04
Nodes (58): AdminAiSettingsPage(), getInitialSettings(), AdminBlogListPage(), getPosts(), AdminBookingsPage(), AdminCalendarPage(), AdminDoorPage(), AdminMemberDetailPage() (+50 more)
...
### Community 13 - "Nav.tsx"
Cohesion: 0.05
Nodes (36): errorKey(), LoginForm(), safeReturnUrl(), DoorCardTable(), AccountMenu(), menuItemStyle, TIER_ACCENT, AppleSignInButton() (+28 more)
...
Cohesion: 0.07
Nodes (41): AdminSettingsPage(), EASE, SPRING, EASE, fmt(), PeriodPricingSections(), ALL_TOOLS, checkAvailability (+33 more)
...
Cohesion: 0.07
Nodes (44): acceptInvite(), AcceptInvitePage(), InviteLookup, Layout(), ALLOWED_REDIRECT_SCHEMES, failureMap, getClientIp(), POST() (+36 more)
...
Cohesion: 0.08
Nodes (25): AboutPage(), META, Home(), generateMetadata(), PricingPage(), META, VenuePage(), Directions() (+17 more)
...
Cohesion: 0.07
Nodes (49): AdminBookingDetailPage(), getBookingDetail(), isRecord(), PATCH(), GET(), isRecord(), PATCH(), GET() (+41 more)
...
Cohesion: 0.17
Nodes (13): AppleLogo(), AppleLogoProps, Logo(), LogoProps, NOTE: there is no black-on-transparent "mark only" export in the current, AlipayLogo(), ApplePayLogo(), GooglePayLogo() (+5 more)
...
Cohesion: 0.08
Nodes (47): resolveProjectRoot(), firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath() (+39 more)
...
### Community 324 - "getAiWidgetSettings.ts"
Cohesion: 0.27
...
### Community 340 - ".agents/skills/impeccable/scripts/live/instructions.mjs"
Cohesion: 0.40
...
### Community 354 - "SlotCalendar.tsx"
Cohesion: 0.31
...
### Community 409 - "expandScanTargets"
Cohesion: 0.36
...
Cohesion: 0.11
Nodes (43): Block, isValidBlock(), POST(), Block, isValidBlock(), POST(), POST(), POST() (+35 more)
...
### Community 450 - "isRepeatedTextContainer"
Cohesion: 0.25
Nodes (8): checkLayout(), checkPageLayout(), isCardLike(), isCardLikeDOM(), isCardLikeFromProps(), isRepeatedTextContainer(), parseRadiusToPx(), resolveBorderRadiusPx()
...
Cohesion: 0.20
Nodes (10): AdminSidebar(), NAV_ITEMS, NavItem, QuickActions(), statusColor(), TeamTable(), AdminContext, AdminProvider() (+2 more)
...
### Community 497 - "isScreenReaderOnlyTextStyle"
Cohesion: 0.47
Nodes (6): clippedByInset(), clippedByRect(), expandBoxShorthand(), firstMetricLengthPx(), isScreenReaderOnlyTextStyle(), metricLengthPx()
...
### Community 500 - "Adaptation Strategies"
Cohesion: 0.40
...
## Knowledge Gaps
- **2340 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2335 more)
