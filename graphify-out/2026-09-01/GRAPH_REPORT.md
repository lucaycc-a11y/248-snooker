# Graph Report - Space8_web  (2026-09-01)

## Corpus Check
- 1010 files · ~2,160,669 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10058 nodes · 22168 edges · 579 communities (506 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 342 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0dca6d3`
...
1. `getServiceSupabase()` - 233 edges
2. `getAdminData()` - 103 edges
...
- `AdminMembersPage()` --calls--> `getAdminMembers()`  [EXTRACTED]
  app/admin/members/page.tsx → lib/data/getAdminMembers.ts
...
## Communities (579 total, 73 thin omitted)

### Community 0 - "AuthCard.tsx"
Cohesion: 0.10
Nodes (15): errorKey(), LoginForm(), safeReturnUrl(), AuthCard(), ContactTab, EASE, Grecaptcha, isGrecaptcha() (+7 more)
...
Cohesion: 0.05
Nodes (57): ALL_TABLES, BookPage(), Calendar(), CellState, cellStateFor(), CONFIG, ConfirmationTicket, ConfirmedBooking (+49 more)

### Community 5 - "MemberDashboard.tsx"
Cohesion: 0.07
Nodes (22): bookingEnd(), BookingSection(), bookingStart(), calendarLink(), canRefund(), canReschedule(), canShowQr(), EASE (+14 more)
...
Cohesion: 0.05
Nodes (44): AdminAiSettingsPage(), getInitialSettings(), AdminBlogListPage(), getPosts(), AccessLog, DeviceStatus, LockoutStatus, RelayStatus (+36 more)

### Community 12 - "createClient"
Cohesion: 0.09
Nodes (28): acceptInvite(), AcceptInvitePage(), InviteLookup, ALLOWED_REDIRECT_SCHEMES, failureMap, getClientIp(), POST(), POST() (+20 more)

### Community 13 - "SettingsForm.tsx"
Cohesion: 0.11
Nodes (21): BookingRulesSection(), BookingRulesValue, ConfigKey, DiffRow, fieldRowStyle(), PricingRatesValue, PricingSection(), SectionShell() (+13 more)
...
Cohesion: 0.19
Nodes (11): AdminDashboardPage(), isLayoutArray(), isLayoutItem(), VALID_ID_SET, VALID_SIZES, DashboardGridProps, SIZE_CLASSES, DEFAULT_LAYOUT (+3 more)
...
Cohesion: 0.09
Nodes (34): AdminSettingsPage(), GET(), GET(), localized(), LocalizedString, generateMetadata(), EASE, SPRING (+26 more)
...
Cohesion: 0.09
Nodes (30): EASE, DOC_IDS, generateMetadata(), LegalPage(), resolveDocId(), accessibilityEn, accessibilityZhCN, accessibilityZhHK (+22 more)
...
Cohesion: 0.06
Nodes (51): buildSystemPrompt(), ChatBody, ChatMessage, escapeXml(), getRiskLevel(), hasPendingActionId(), POST(), tryParseStructuredResponse() (+43 more)
...
Cohesion: 0.09
Nodes (24): AboutPage(), META, Home(), PricingPage(), META, VenuePage(), AuthModal(), Logo() (+16 more)
...
Cohesion: 0.11
Nodes (19): metadata, UpdatePasswordPage(), ComingSoonPage(), metadata, LoginPage(), metadata, safeReturnUrl(), MemberBookingPage() (+11 more)
...
Cohesion: 0.05
Nodes (93): POST(), ExistingRow, normalizedEmail(), POST(), SignupBody, normalizedEmail(), POST(), SignupBody (+85 more)

### Community 61 - "service.ts"
Cohesion: 0.07
Nodes (49): AdminBookingDetailPage(), getBookingDetail(), AdminBookingsPage(), metadata, AdminCalendarPage(), CancelRequest, POST(), isRecord() (+41 more)
...
Cohesion: 0.06
Nodes (35): animejs, @anthropic-ai/sdk, bcryptjs, canvas-confetti, @dnd-kit/core, libphonenumber-js, matter-js, dependencies (+27 more)
...
### Community 143 - "widgetRegistry.ts"
Cohesion: 0.12
Nodes (19): SortableWidget(), ActiveUsersWidget(), Anomaly, AnomalyWidget(), STATUS_COLORS, STATUS_LABELS, PendingAction, PendingWidget() (+11 more)
...
### Community 230 - ".agents/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.20
...
### Community 266 - "AboutContent.tsx"
Cohesion: 0.13
...
### Community 269 - "admin/layout.tsx"
Cohesion: 0.10
Nodes (22): Layout(), AdminSidebar(), NAV_ITEMS, NavItem, AdminThemeSync(), AdminThemeSyncProps, MobileTabBar(), Tab (+14 more)
...
### Community 274 - ".agents/skills/impeccable/scripts/live/insert-ui.mjs"
Cohesion: 0.11
Nodes (10): canCreateInsert(), clampPlaceholderSize(), computeInsertPosition(), groupSiblingRows(), hitSiblingInsertGap(), horizontalOverlap(), insertCreateDisabledReason(), insertLineCoords() (+2 more)
...
### Community 288 - ".claude/skills/impeccable/scripts/context-signals.mjs"
Cohesion: 0.14
...
### Community 298 - ".claude/skills/impeccable/scripts/live/session-store.mjs"
Cohesion: 0.08
Nodes (36): safeSessionId(), AGENT_PHASE_SET, FORBIDDEN_MANUAL_EDIT_TEXT_CHARS, INSERT_POSITIONS, isValidId(), isValidMountVariant(), isValidVariantId(), validateAnnotationFields() (+28 more)
...
### Community 303 - "resolveLiveInjectionAnchor"
Cohesion: 0.62
...
### Community 304 - "[locale]/page.tsx"
Cohesion: 0.06
Nodes (27): FaqPage(), META, Directions(), EASE, FAQ(), VIEWPORT, FaqItem, getFaqItems() (+19 more)
...
### Community 307 - "createClient"
Cohesion: 0.14
Nodes (15): DoorCardTable(), AIInsightsWidget(), InsightPayload, AccountMenu(), menuItemStyle, TIER_ACCENT, AppleSignInButton(), GoogleSignInButton() (+7 more)
...
### Community 311 - "resolveLiveInjectionAnchor"
Cohesion: 0.16
...
### Community 313 - "create-renewal-order/route.ts"
Cohesion: 0.20
Nodes (13): GET(), GET(), maskEmail(), maskPhone(), timePeriod(), welcomeTier(), POST(), Body (+5 more)
...
### Community 324 - "validatePassword"
Cohesion: 0.20
...
### Community 339 - "navigation.ts"
Cohesion: 0.07
Nodes (18): bebasNeue, metadata, viewport, EN, getSortedPhrases(), highlightKeyPhrases(), PHRASES_BY_LOCALE, IMPORTANT: this file does not alter a single character of the verbatim (+10 more)

### Community 340 - "checkElementDesignSystemDOM"
Cohesion: 0.15
...
### Community 362 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
...
Cohesion: 0.21
Nodes (10): metadata, anomalyBadge(), ApiResponse, formatDate(), formatHKD(), PaymentEntry, PaymentLogClient(), ReconcileModal() (+2 more)
...
### Community 409 - "checkElementBorders"
Cohesion: 0.47
...
### Community 418 - "expandScanTargets"
Cohesion: 0.36
Nodes (8): coLocatedStylesheets(), expandScanTargets(), hasPathTraversal(), isInsideProject(), looksLikeProjectRoot(), normalizeScanTargets(), parseStaticStyleImports(), resolveCacheCwd()
...
### Community 434 - "addVisualContrastFindings"
Cohesion: 0.19
...
### Community 450 - "TicketCard.tsx"
Cohesion: 0.18
Nodes (9): DAY_NAMES, padTime(), PAYMENT_ICON_MAP, TicketCard(), TicketCardProps, TicketPrinter(), TicketPrinterProps, TABLE_NAMES (+1 more)
...
### Community 463 - "ProfileCompletion.tsx"
Cohesion: 0.24
...
Cohesion: 0.04
Nodes (82): AdminTeamPage(), AdminUserRow, GET(), isRecord(), LOCALES, POST(), TONES, DELETE() (+74 more)

### Community 465 - "signup-state 2.ts"
Cohesion: 0.29
Nodes (5): canFinalize(), FinalizableAttempt, isExpired(), SignupMethod, SignupStatus

### Community 466 - "ReschedulePicker.tsx"
Cohesion: 0.21
Nodes (9): estimateRefund(), RefundConfirmModal(), SPRING, availableStartHours(), DaySlotRow, ReschedulePicker(), SPRING, toDateInputValue() (+1 more)
...
### Community 471 - "Responsive Design"
Cohesion: 0.20
...
### Community 497 - "MemberQrGuide.tsx"
Cohesion: 0.28
Nodes (6): EASE, FEATURE_ICONS, STEP_ICONS, QRCode(), renderQrDataUrl(), SPRING

### Community 498 - ".agents/skills/impeccable/reference/doctor.md"
Cohesion: 0.25
...
### Community 506 - ".claude/skills/impeccable/reference/bolder.md"
Cohesion: 0.33
...
### Community 515 - "Extract Flow"
Cohesion: 0.25
Nodes (7): Extract Flow, Step 1: Discover the Design System, Step 2: Identify Patterns, Step 3: Plan Extraction, Step 4: Extract & Enrich, Step 5: Migrate, Step 6: Document

### Community 521 - ".claude/skills/impeccable/scripts/lib/target-args.mjs"
Cohesion: 0.36
Nodes (5): parseCliOptions(), parseTargetOptions(), parseTargetPath(), TargetArgError, resolveLiveTarget()

### Community 522 - "postSerializedFindings"
Cohesion: 0.40
...
### Community 545 - "checkElementBorders"
Cohesion: 0.47
Nodes (6): checkBorders(), checkElementBorders(), checkElementBordersDOM(), isStatusContextElement(), isTabContextElement(), isNeutralColor()
...
### Community 572 - "Diagnostic Scan"
Cohesion: 0.33
Nodes (6): 1. Accessibility (VoiceOver / TalkBack), 2. Performance, 3. Appearance & Theming, 4. Platform Conformance (CRITICAL), 5. Adaptivity, Diagnostic Scan

### Community 573 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 574 - ".claude/skills/impeccable/scripts/hook.mjs"
Cohesion: 0.70
Nodes (4): isStopEvent(), writeAuditLog(), main(), readStdin()

### Community 575 - "MemberBookingCalendar.tsx"
Cohesion: 0.60
Nodes (4): MemberBookingCalendar(), MemberBookingDay, monthLabel(), statusColor()

### Community 576 - "blog/[id]/page.tsx"
Cohesion: 0.83
Nodes (3): AdminBlogEditPage(), getPost(), getSiblings()

## Knowledge Gaps
- **2598 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2593 more)
...
- **Why does `el()` connect `el` to `.agents/skills/impeccable/scripts/live-browser.js`, `connectSSE`, `initGlobalBar`, `.agents/skills/impeccable/scripts/detector/detect-antipatterns-browser.js`, `parseRgb`, `postSerializedFindings`, `.agents/skills/impeccable/scripts/detector/engines/static-html/css-cascade.mjs`, `.agents/skills/impeccable/scripts/detector/design-system.mjs`, `.agents/skills/impeccable/scripts/live/svelte-ast.mjs`, `.agents/skills/impeccable/scripts/detector/browser/injected/index.mjs`, `.agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs`, `.agents/skills/impeccable/scripts/detector/rules/checks.mjs`, `isRepeatedTextContainer`, `collectBrowserFindings`, `setLiveState`, `initPageChat`, `.agents/skills/impeccable/scripts/detector/engines/regex/detect-text.mjs`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
