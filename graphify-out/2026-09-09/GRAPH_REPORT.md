# Graph Report - Space8_web  (2026-09-09)

## Corpus Check
- 1084 files · ~2,168,953 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10407 nodes · 22741 edges · 592 communities (508 shown, 84 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 342 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `762e5b40`
...
## Communities (592 total, 84 thin omitted)

### Community 0 - ".agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs"
Cohesion: 0.13
...
Cohesion: 0.04
Nodes (65): ALL_TABLES, BookPage(), Calendar(), CellState, cellStateFor(), CONFIG, ConfirmationTicket, ConfirmedBooking (+57 more)
...
Cohesion: 0.04
Nodes (71): isRecord(), POST(), POST(), POST(), GET(), assertRpcSucceeded(), BookingPaymentContext, ConfirmBookingResult (+63 more)
...
Cohesion: 0.08
Nodes (30): SortableWidget(), DoorCardTable(), ActiveUsersWidget(), AIInsightsWidget(), InsightPayload, Anomaly, AnomalyWidget(), STATUS_COLORS (+22 more)
...
Cohesion: 0.12
Nodes (22): AdminDashboardPage(), isLayoutArray(), GET(), GET(), isLayoutArray(), isLayoutItem(), PUT(), VALID_ID_SET (+14 more)
...
Cohesion: 0.08
Nodes (31): GET(), GET(), localized(), LocalizedString, EASE, SPRING, fmt(), HomePricing() (+23 more)
...
Cohesion: 0.08
Nodes (26): AdminSettingsPage(), AboutPage(), META, Home(), generateMetadata(), PricingPage(), META, VenuePage() (+18 more)
...
### Community 44 - "TicketCard.tsx"
Cohesion: 0.08
Nodes (22): BallSpec, createBall(), createBallSpecs(), drawEightBallGlow(), drawEightBallLabel(), drawFeltTexture(), drawPocketRims(), homePositionFor() (+14 more)
...
### Community 60 - "mountSvelteComponentVariant"
Cohesion: 0.11
...
Cohesion: 0.14
Nodes (21): metadata, UpdatePasswordPage(), ComingSoonPage(), metadata, LoginPage(), metadata, safeReturnUrl(), MemberBookingPage() (+13 more)
...
### Community 64 - "resolveLiveInjectionAnchor"
Cohesion: 0.62
...
Cohesion: 0.16
Nodes (21): firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveConfigPath(), getLiveAnnotationsDir(), getLiveConfigPath(), getLiveDir() (+13 more)

### Community 127 - ".claude/skills/impeccable/scripts/hook-lib.mjs"
Cohesion: 0.06
Nodes (51): extractPlatform(), loadContext(), ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyPatchText(), canonicalPath(), canonicalPathCache (+43 more)
...
Cohesion: 0.08
Nodes (58): findTargetExample(), hasVisualImplementation(), applyFixes(), cli(), collect(), readProjectRootPatterns(), rel(), renderText() (+50 more)
...
### Community 148 - ".claude/skills/impeccable/scripts/lib/surface-briefs.mjs"
Cohesion: 0.34
...
### Community 150 - "routing.ts"
Cohesion: 0.08
Nodes (25): bebasNeue, geist, metadata, viewport, EASE, EN, getSortedPhrases(), highlightKeyPhrases() (+17 more)
...
### Community 215 - "getAdminCalendar.ts"
Cohesion: 0.21
...
### Community 243 - ".agents/skills/impeccable/scripts/detector/engines/browser/detect-url.mjs"
Cohesion: 0.20
...
Cohesion: 0.10
Nodes (27): checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), checkRadialSpotlight(), checkTextOcclusionDOM(), clamp01(), colorFunctionToRgb(), decodeSrgbChannel(), elementDirectText() (+19 more)
...
Cohesion: 0.10
Nodes (26): checkElementHeroEyebrowDOM(), checkElementQualityDOM(), checkHeroEyebrow(), checkKickerAboveHeading(), checkKickerAboveHeadingDOM(), checkKickerAboveHeadingFromDoc(), checkNumberedSectionLabels(), checkNumberedSectionLabelsDOM() (+18 more)
...
### Community 304 - "Footer.tsx"
Cohesion: 0.14
Nodes (16): errorKey(), LoginForm(), safeReturnUrl(), AppleLogo(), AppleLogoProps, Logo(), LogoProps, NOTE: there is no black-on-transparent "mark only" export in the current (+8 more)
...
### Community 339 - ".claude/skills/impeccable/scripts/lib/staleness-notice.mjs"
Cohesion: 0.38
...
### Community 391 - "admin/layout.tsx"
Cohesion: 0.15
Nodes (14): Layout(), AdminThemeSync(), AdminThemeSyncProps, MobileTabBar(), Tab, TABS, linkStyle, primaryLinkStyle (+6 more)
...
### Community 418 - "rateLimit"
Cohesion: 0.04
Nodes (110): POST(), POST(), ExistingRow, normalizedEmail(), POST(), SignupBody, normalizedEmail(), POST() (+102 more)
...
Cohesion: 0.06
Nodes (69): isValidPayment(), isValidSlot(), ManualCreateRequest, PaymentInfo, POST(), SlotInfo, POST(), SlotCheckRequest (+61 more)
...
### Community 436 - "AuthCard.tsx"
Cohesion: 0.07
Nodes (26): UpdatePasswordForm(), AppleSignInButton(), AuthCard(), ContactTab, EASE, Grecaptcha, isGrecaptcha(), OtpChannel (+18 more)
...
Cohesion: 0.03
Nodes (124): AdminTeamPage(), AdminUserRow, GET(), isRecord(), LOCALES, POST(), TONES, GET() (+116 more)
...
### Community 511 - "resolveProjectRoot"
Cohesion: 0.29
...
### Community 515 - "checkElementBorders"
Cohesion: 0.47
...
Cohesion: 0.13
Nodes (12): IconButton(), IconButtonProps, PillButton(), PillButtonProps, LineChart(), PendingActionCard(), RingChart(), transactions (+4 more)

### Community 551 - "createClient"
Cohesion: 0.10
Nodes (24): acceptInvite(), AcceptInvitePage(), InviteLookup, ALLOWED_REDIRECT_SCHEMES, failureMap, getClientIp(), POST(), Body (+16 more)
...
## Knowledge Gaps
- **2730 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2725 more)
...
- **Why does `el()` connect `el` to `.agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs`, `.agents/skills/impeccable/scripts/live-browser.js`, `connectSSE`, `initGlobalBar`, `.agents/skills/impeccable/scripts/detector/detect-antipatterns-browser.js`, `parseRgb`, `.agents/skills/impeccable/scripts/detector/engines/static-html/css-cascade.mjs`, `.agents/skills/impeccable/scripts/detector/design-system.mjs`, `.agents/skills/impeccable/scripts/live/svelte-ast.mjs`, `.agents/skills/impeccable/scripts/detector/rules/checks.mjs`, `collectBrowserFindings`, `analyzeVisualContrastCandidate`, `css`, `initPageChat`, `.agents/skills/impeccable/scripts/detector/engines/regex/detect-text.mjs`, `setLiveState`?**
...
- **Should `.agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs` be split into smaller, more focused modules?**
