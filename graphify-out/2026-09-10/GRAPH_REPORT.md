# Graph Report - Space8_web  (2026-09-10)

## Corpus Check
- 1077 files · ~2,168,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10392 nodes · 22714 edges · 600 communities (516 shown, 84 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 342 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80d88197`
...
1. `getServiceSupabase()` - 276 edges
2. `getAdminData()` - 137 edges
3. `createClient()` - 72 edges
...
## Communities (600 total, 84 thin omitted)

### Community 0 - "verify-phone/route.ts"
Cohesion: 0.10
Nodes (41): Body, POST(), SignupAttempt, Body, POST(), SignupAttempt, Body, isAlreadyRegistered() (+33 more)
...
Cohesion: 0.15
Nodes (23): resolveTargetSelection(), parseTargetPath(), __dirname, ensureServerRunning(), globToRegex(), globToRegex(), resolveFiles(), acceptInstructions() (+15 more)
...
Cohesion: 0.04
Nodes (69): isRecord(), POST(), POST(), POST(), GET(), assertRpcSucceeded(), BookingPaymentContext, ConfirmBookingResult (+61 more)
...
Cohesion: 0.03
Nodes (129): addManualContextText(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+121 more)

### Community 11 - "tokens.ts"
Cohesion: 0.03
Nodes (85): AdminAiSettingsPage(), getInitialSettings(), AdminBlogEditPage(), getPost(), getSiblings(), AdminBlogListPage(), getPosts(), AccessLog (+77 more)
...
Cohesion: 0.05
Nodes (41): SettingsTab(), DashboardGridProps, SIZE_CLASSES, SortableWidget(), ActiveUsersWidget(), AIInsightsWidget(), InsightPayload, Anomaly (+33 more)
...
Cohesion: 0.06
Nodes (44): AdminSettingsPage(), GET(), GET(), localized(), LocalizedString, EASE, SPRING, MemberPage() (+36 more)
...
### Community 24 - ".claude/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (43): applyEditing(), buildInsertPlaceholderSnapshotFromDom(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), canRestoreManualEditElement(), captureAndEmit(), checkpointPayload(), copyEditContainerContext() (+35 more)
...
Cohesion: 0.10
Nodes (19): AboutPage(), META, Home(), generateMetadata(), PricingPage(), META, VenuePage(), FooterMap (+11 more)
...
Cohesion: 0.05
Nodes (76): getDesignSidecarPath(), getImpeccableDir(), getLiveAnnotationsDir(), getLiveDir(), getLiveServerPath(), removeLiveServerInfo(), writeLiveServerInfo(), assembleLiveBrowserScript() (+68 more)
...
Cohesion: 0.07
Nodes (27): metadata, UpdatePasswordPage(), ComingSoonPage(), metadata, LoginPage(), metadata, safeReturnUrl(), MemberBookingPage() (+19 more)

### Community 62 - "validatePassword"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (19): EASE, EN, getSortedPhrases(), highlightKeyPhrases(), PHRASES_BY_LOCALE, IMPORTANT: this file does not alter a single character of the verbatim, SORTED_BY_LOCALE, ZH_CN (+11 more)
...
Cohesion: 0.06
Nodes (59): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyConfigSource(), applyDetectorConfigSource(), canonicalPath(), canonicalPathCache, clampByte() (+51 more)

### Community 131 - "dependencies"
Cohesion: 0.05
Nodes (37): animejs, bcryptjs, @dnd-kit/core, google-auth-library, lucide-react, next, dependencies, animejs (+29 more)
...
Cohesion: 0.06
Nodes (52): ACK_EXTS, ADVISORY_RULES, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPathCache, clampByte(), cloneDefaultConfig() (+44 more)
...
Cohesion: 0.14
Nodes (20): resolveProjectRoot(), firstExisting(), getDesignSidecarCandidates(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLiveAnnotationsDir() (+12 more)
...
### Community 146 - "mountSvelteComponentVariant"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (13): bebasNeue, metadata, viewport, Item, Translation, CardItem, ICONS, highlight() (+5 more)
...
Cohesion: 0.06
Nodes (37): assertRpcSucceeded(), BookingSummary, ConfirmBookingResult, handleFailed(), handleRefunded(), handleSucceeded(), markWebhookFailed(), markWebhookProcessed() (+29 more)
...
### Community 231 - ".agents/skills/impeccable/scripts/live/insert-ui.mjs"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (54): isLiveServerPidReachable(), matchesTemplateExtension(), readLiveTemplateExtensions(), resolveLiveTemplateExtensions(), safeReadJson(), acceptCli(), acceptReceiptPath(), argVal() (+46 more)
...
Cohesion: 0.14
Nodes (22): getLegacyLiveConfigPath(), getLiveConfigPath(), resolveLiveConfigPath(), describeInjectArtifacts(), frameworkIgnorePatterns(), resolveFramework(), applyNuxtLiveAdapter(), buildNuxtPlugin() (+14 more)
...
### Community 272 - ".claude/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.50
...
### Community 274 - "num"
Cohesion: 0.05
Nodes (58): AdminBookingDetailPage(), getBookingDetail(), AdminBookingsPage(), metadata, AdminMemberDetailPage(), getMemberDetail(), TIER_BG_VAR, TIER_COLOR_VAR (+50 more)
...
Cohesion: 0.08
Nodes (42): resolveProjectRoot(), firstExisting(), getDesignSidecarCandidates(), getLegacyLiveAnnotationsDir(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir(), getLiveSessionsDir(), readLiveServerInfo() (+34 more)
...
### Community 285 - ".claude/skills/impeccable/scripts/live/insert-ui.mjs"
Cohesion: 0.11
Nodes (10): canCreateInsert(), clampPlaceholderSize(), computeInsertPosition(), groupSiblingRows(), hitSiblingInsertGap(), horizontalOverlap(), insertCreateDisabledReason(), insertLineCoords() (+2 more)
...
### Community 303 - "checkElementGptBorderShadowDOM"
Cohesion: 0.32
...
Cohesion: 0.12
Nodes (20): MemberActions(), Props, SheetMode, VALID_TIERS, ACTIVITY_DOT, ActivityStatus, AVATAR_COLORS, avatarColor() (+12 more)
...
### Community 346 - "renderGroupedTemplate"
Cohesion: 0.31
Nodes (11): cursorBlockMessage(), clampGroupedToBudget(), clampLastLine(), clampToBudget(), commitFooterShown(), directiveFooter(), footerFallbacks(), formatDedupedFindingLine() (+3 more)
...
### Community 367 - "Nav.tsx"
Cohesion: 0.12
Nodes (21): errorKey(), LoginForm(), safeReturnUrl(), AuthModal(), AppleLogo(), AppleLogoProps, Logo(), LogoProps (+13 more)

### Community 368 - ".agents/skills/impeccable/scripts/live/frameworks/index.mjs"
Cohesion: 0.14
Nodes (13): astro, COMMENT_SYNTAXES, FRAMEWORKS, INJECT_KINDS, PREVIEW_MODES, SOURCE_TRAIT_DEFAULTS, STYLE_MODES, nextjs (+5 more)
...
### Community 418 - "service.ts"
Cohesion: 0.04
Nodes (88): acceptInvite(), AcceptInvitePage(), InviteLookup, ALLOWED_REDIRECT_SCHEMES, failureMap, getClientIp(), POST(), Body (+80 more)
...
Cohesion: 0.06
Nodes (70): isValidPayment(), isValidSlot(), ManualCreateRequest, PaymentInfo, POST(), SlotInfo, POST(), SlotCheckRequest (+62 more)
...
### Community 436 - "getAdminCalendar.ts"
Cohesion: 0.21
...
### Community 462 - "AboutContent.tsx"
Cohesion: 0.13
...
Cohesion: 0.03
Nodes (112): Layout(), AdminTeamPage(), AdminUserRow, GET(), isRecord(), LOCALES, POST(), TONES (+104 more)

### Community 465 - "signup-state 2.ts"
Cohesion: 0.29
Nodes (5): canFinalize(), FinalizableAttempt, isExpired(), SignupMethod, SignupStatus

### Community 466 - "expandScanTargets"
Cohesion: 0.36
...
### Community 494 - "SettingsForm.tsx"
Cohesion: 0.17
...
### Community 501 - ".claude/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.21
...
### Community 513 - ".claude/skills/impeccable/scripts/hook.mjs"
Cohesion: 0.83
...
### Community 515 - ".claude/skills/impeccable/scripts/lib/template-extensions.mjs"
Cohesion: 0.27
...
### Community 524 - "checkElementGptBorderShadowDOM"
Cohesion: 0.32
Nodes (8): borderColorsFromStyle(), borderWidthsFromStyle(), checkElementGptBorderShadow(), checkElementGptBorderShadowDOM(), checkGptThinBorderWideShadow(), cssColorAlpha(), shadowLayerAlpha(), shadowMaxBlurPx()
...
### Community 546 - "booking-status/route.ts"
Cohesion: 0.60
Nodes (5): GET(), maskEmail(), maskPhone(), timePeriod(), welcomeTier()

### Community 547 - "BarChart.tsx"
Cohesion: 0.40
...
### Community 553 - "normalizeGitHubEvent"
Cohesion: 0.47
...
### Community 560 - "Section2Value.tsx"
Cohesion: 0.53
Nodes (5): clamp01(), layerOpacity(), Panel, PANELS, Section2Value()
...
### Community 592 - "Adaptation Strategies"
Cohesion: 0.40
Nodes (5): Adaptation Strategies, Orientation & foldables, Phone → Tablet (iPad / large screens), Platform → platform (iOS ↔ Android), Web → native (porting a website or web app)
...
## Knowledge Gaps
- **2728 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2723 more)
