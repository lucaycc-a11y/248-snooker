...
## Corpus Check
- 902 files · ~1,922,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9606 nodes · 21334 edges · 525 communities (465 shown, 60 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 338 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05215b5a`
...
## Communities (525 total, 60 thin omitted)

### Community 0 - "AmbientGlow.tsx"
Cohesion: 0.33
Nodes (6): AmbientGlow(), AmbientGlowVariant, BRAND_EDGES, EdgeGlow, GEMINI_EDGES, useReducedMotion()
...
Cohesion: 0.08
Nodes (16): Directions(), EASE, GalleryScroll(), mediaItems, slideImages, EASE, Facility, FACILITY_ICONS (+8 more)
...
Cohesion: 0.08
Nodes (20): bookingEnd(), BookingSection(), bookingStart(), calendarLink(), canRefund(), canReschedule(), canShowQr(), EASE (+12 more)

### Community 6 - "template-send.ts"
Cohesion: 0.05
Nodes (53): isRecord(), POST(), GET(), getTableName(), TABLE_NAMES, TableNumber, base64url(), checkChar() (+45 more)
...
Cohesion: 0.04
Nodes (56): AdminAiSettingsPage(), getInitialSettings(), AdminBlogListPage(), getPosts(), AdminBookingsPage(), AdminCalendarPage(), AccessLog, DeviceStatus (+48 more)

### Community 12 - "mountSvelteComponentVariant"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (38): DoorCardTable(), AccountMenu(), menuItemStyle, TIER_ACCENT, AppleSignInButton(), AuthCard(), ContactTab, EASE (+30 more)
...
Cohesion: 0.07
Nodes (43): AdminSettingsPage(), GET(), GET(), localized(), LocalizedString, ComingSoonPage(), metadata, EASE (+35 more)
...
Cohesion: 0.08
Nodes (34): EASE, EN, getSortedPhrases(), highlightKeyPhrases(), PHRASES_BY_LOCALE, IMPORTANT: this file does not alter a single character of the verbatim, SORTED_BY_LOCALE, ZH_CN (+26 more)
...
Cohesion: 0.07
Nodes (44): AdminDashboardPage(), ChatMessage, isRecord(), POST(), GET(), isRecord(), POST(), isRecord() (+36 more)
...
### Community 31 - "jsonLd.ts"
Cohesion: 0.14
Nodes (15): AboutPage(), META, Home(), generateMetadata(), PricingPage(), META, VenuePage(), WhatsAppButton() (+7 more)
...
### Community 51 - ".claude/skills/impeccable/scripts/live/insert-ui.mjs"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (85): POST(), POST(), ExistingRow, normalizedEmail(), POST(), SignupBody, VALID, Body (+77 more)

### Community 61 - "service.ts"
Cohesion: 0.09
Nodes (37): AdminBookingDetailPage(), getBookingDetail(), AdminMemberDetailPage(), getMemberDetail(), isRecord(), PATCH(), GET(), isRecord() (+29 more)
...
### Community 64 - ".claude/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.24
...
Cohesion: 0.06
Nodes (35): animejs, bcryptjs, canvas-confetti, leaflet, libphonenumber-js, lucide-react, matter-js, next-intl (+27 more)
...
### Community 158 - ".claude/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.21
...
### Community 267 - "ReschedulePicker.tsx"
Cohesion: 0.21
...
### Community 269 - ".agents/skills/impeccable/scripts/live/accept-css.mjs"
Cohesion: 0.20
...
### Community 276 - "MemberQrGuide.tsx"
Cohesion: 0.28
...
### Community 278 - ".agents/skills/impeccable/scripts/live/browser-script-parts.mjs"
Cohesion: 0.21
Nodes (9): assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts(), resolveLiveBrowserScriptParts(), loadBrowserScripts(), LIVE_CHROME_MOUNT_CONTRACT, LIVE_UI_COMPONENT_IDS (+1 more)
...
### Community 282 - ".agents/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.50
...
### Community 307 - "checkElementBorders"
Cohesion: 0.47
...
### Community 328 - ".claude/skills/impeccable/reference/bolder.md"
Cohesion: 0.33
...
### Community 339 - "Section2Value.tsx"
Cohesion: 0.53
Nodes (5): clamp01(), layerOpacity(), Panel, PANELS, Section2Value()

### Community 340 - ".agents/skills/impeccable/scripts/live/source-search.mjs"
Cohesion: 0.50
...
### Community 362 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 409 - ".agents/skills/impeccable/reference/bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat
...
### Community 426 - "Nav.tsx"
Cohesion: 0.08
Nodes (24): EASE, FLAP_MESSAGES, VIEWPORT, errorKey(), LoginForm(), safeReturnUrl(), AuthModal(), Logo() (+16 more)
...
Cohesion: 0.07
Nodes (65): Block, isValidBlock(), POST(), Block, isValidBlock(), POST(), POST(), POST() (+57 more)
...
### Community 459 - "checkElementHeroEyebrowDOM"
Cohesion: 0.40
...
### Community 462 - "applyDeferredSvelteComponentAccepts"
Cohesion: 0.60
...
### Community 463 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
Nodes (4): 1.A Dial Inference (design read → dial values), 1.B Use-Case Presets, 1.C How the Dials Drive Output, 1. THE THREE DIALS (Core Configuration)

### Community 464 - "getServiceSupabase"
Cohesion: 0.04
Nodes (83): AdminBlogEditPage(), getPost(), getSiblings(), AdminTeamPage(), AdminUserRow, GET(), isRecord(), LOCALES (+75 more)
...
## Knowledge Gaps
- **2444 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `PING_KINDS` (+2439 more)
...
- **Why does `el()` connect `el` to `.agents/skills/impeccable/scripts/live-browser.js`, `connectSSE`, `initGlobalBar`, `.agents/skills/impeccable/scripts/detector/detect-antipatterns-browser.js`, `parseRgb`, `.agents/skills/impeccable/scripts/detector/engines/static-html/css-cascade.mjs`, `mountSvelteComponentVariant`, `.agents/skills/impeccable/scripts/detector/design-system.mjs`, `.agents/skills/impeccable/scripts/live/svelte-ast.mjs`, `.agents/skills/impeccable/scripts/detector/browser/injected/index.mjs`, `.agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs`, `.agents/skills/impeccable/scripts/detector/rules/checks.mjs`, `collectBrowserFindings`, `setLiveState`, `initPageChat`, `.agents/skills/impeccable/scripts/detector/engines/regex/detect-text.mjs`?**
