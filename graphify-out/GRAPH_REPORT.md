# Graph Report - Space8_web  (2026-07-30)

## Corpus Check
- 450 files · ~797,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1826 nodes · 3302 edges · 225 communities (170 shown, 55 thin omitted)
...
1. `getServiceSupabase()` - 121 edges
...
Cohesion: 0.15
Nodes (23): AdminTeamPage(), AdminUserRow, Block, isValidBlock(), POST(), POST(), POST(), POST() (+15 more)

### Community 1 - "bookings/route.ts"
Cohesion: 0.47
Nodes (5): AdminBookingsPage(), GET(), isRecord(), PATCH(), getAdminBookings()

### Community 2 - "createClient"
Cohesion: 0.19
Nodes (11): acceptInvite(), AcceptInvitePage(), InviteLookup, Layout(), POST(), GET(), POST(), GET() (+3 more)
...
### Community 6 - "send.ts"
Cohesion: 0.06
Nodes (55): isRecord(), POST(), GET(), assertRpcSucceeded(), BookingPaymentContext, ConfirmBookingResult, handleFailed(), handleGroupSucceeded() (+47 more)
...
Cohesion: 0.17
Nodes (14): BlogPostPage(), formatDate(), generateMetadata(), localePath(), ALLOWED_TAGS, Attrs, filterAttrs(), parse() (+6 more)
...
### Community 10 - "ai-settings/route.ts"
Cohesion: 0.40
Nodes (5): GET(), isRecord(), LOCALES, POST(), TONES

### Community 11 - "tokens.ts"
Cohesion: 0.13
Nodes (12): AdminBlogListPage(), getPosts(), AccessLog, DeviceStatus, LockoutStatus, RelayStatus, AdminMembersPage(), Tokens (+4 more)

### Community 12 - "tools.ts"
Cohesion: 0.07
Nodes (46): AdminDashboardPage(), money(), ChatMessage, isRecord(), POST(), GET(), GET(), ASK_CHOICE_DEFINITION (+38 more)
...
Cohesion: 0.07
Nodes (32): BallSpec, createBall(), createBallSpecs(), drawEightBallGlow(), drawEightBallLabel(), drawFeltTexture(), drawPocketRims(), homePositionFor() (+24 more)

### Community 28 - "TeamTable.tsx"
Cohesion: 0.17
Nodes (13): AdminSidebar(), NAV_ITEMS, NavItem, linkStyle, primaryLinkStyle, QuickActions(), statusColor(), TeamTable() (+5 more)

### Community 29 - "BlogList.tsx"
Cohesion: 0.22
Nodes (7): CATEGORIES, EASE, formatDate(), GRADIENTS, PostCard(), VIEWPORT, BlogPost

### Community 30 - "Button.tsx"
Cohesion: 0.11
Nodes (16): BlogPost, LOCALES, SiblingPost, Props, SheetMode, TIERS, ApiResponse, Button (+8 more)

### Community 31 - "getConfig"
Cohesion: 0.17
Nodes (15): AdminSettingsPage(), AboutPage(), Home(), generateMetadata(), PricingPage(), META, VenuePage(), getConfig() (+7 more)
...
### Community 56 - "translate/route.ts"
Cohesion: 0.21
Nodes (10): isRecord(), POST(), isRecord(), Locale, LOCALES, POST(), slugify(), TRANSLATE_SCHEMA (+2 more)
...
Cohesion: 0.08
Nodes (41): DELETE(), GET(), isRecord(), LOCALES, PATCH(), GET(), isRecord(), LOCALES (+33 more)

### Community 61 - "getMember.ts"
Cohesion: 0.06
Nodes (56): AdminBookingDetailPage(), getBookingDetail(), AdminCalendarPage(), AdminDoorPage(), AdminMemberDetailPage(), getMemberDetail(), GET(), GET() (+48 more)
...
### Community 65 - "useNfcRegistrationStatus.ts"
Cohesion: 0.40
...
Cohesion: 0.20
Nodes (10): errorKey(), LoginForm(), safeReturnUrl(), AuthCard(), EASE, OtpChannel, Phase, Prefill (+2 more)
...
Cohesion: 0.22
Nodes (9): framer-motion, dependencies, framer-motion, resend, @tiptap/extension-image, @tiptap/extension-link, resend, @tiptap/extension-image (+1 more)
...
Cohesion: 0.14
Nodes (8): Directions(), EASE, GalleryScroll(), mediaItems, slideImages, HEADLINE_GRADIENT, fmt(), HomePricing()

## Knowledge Gaps
- **609 isolated node(s):** `Snooker404TableProps`, `TableSize`, `BallSpec`, `EASE`, `SPRING` (+604 more)
...
- **Why does `getServiceSupabase()` connect `getServiceSupabase` to `service.ts`, `bookings/route.ts`, `createClient`, `site-gate/route.ts`, `send.ts`, `ai-settings/route.ts`, `tokens.ts`, `AiSettingsForm.tsx`, `tools.ts`, `middleware.ts`, `SiteGateLog.tsx`, `profile.ts`, `config/route.ts`, `rateLimit`, `blog/[id]/page.tsx`, `translate/route.ts`, `getMember.ts`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `leaflet`, `send.ts`, `devDependencies`, `next`, `next-intl`, `react-dom`, `@react-email/render`, `react-leaflet`, `@react-three/fiber`, `recharts`, `remotion`, `@remotion/cli`, `@remotion/player`, `stripe`, `@stripe/react-stripe-js`, `@stripe/stripe-js`, `@supabase/ssr`, `@supabase/supabase-js`, `three`, `@tiptap/react`, `@types/canvas-confetti`, `@ybouane/liquidglass`, `@anthropic-ai/sdk`, `matter-js`, `react`, `@tiptap/starter-kit`, `lucide-react`, `canvas-confetti`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `qrcode` connect `send.ts` to `dependencies`?**
