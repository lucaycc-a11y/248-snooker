        ...
        <table role="presentation" width="100%" style="max-width:480px;margin:0 auto;" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td style="background-color:#0a0a0a;border-radius:24px;padding:40px 32px;">
              ...
              <!-- Room & Time -->
              <div style="border-top:1px solid #262626;border-bottom:1px solid #262626;padding:20px 0;margin-bottom:20px;">
              ...
              <div style="margin-bottom:20px;">
                <p style="color:#ffffff;font-size:15px;margin:0 0 4px;">
                  {{customerName}}
                </p>
              ...
              <!-- Price -->
              <div style="border-top:1px solid #262626;padding-top:12px;margin-bottom:8px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td style="color:#22c55e;font-size:15px;text-align:right;">+{{pointsEarned}} pts</td>
                  </tr>
                  <tr>
              ...
              <div style="text-align:center;margin-bottom:24px;">
                <a href="{{bookingDetailUrl}}" style="display:inline-block;background-color:#22c55e;color:#000000;font-size:14px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:12px;">
                  查看預約詳情 View Booking Details
                </a>
              </div>
